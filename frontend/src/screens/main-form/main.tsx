...
<div className='body'>
  <div className='data-field' onClick={onClickCardData}>
    ...
    <div className="data-field" onClick={onClickUserData}>
     <div>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M3.23779 19.5C4.5632 17.2892 7.46807 15.7762 12.0001 15.7762C16.5321 15.7762 19.4369 17.2892 20.7623 19.5M15.6001 8.1C15.6001 10.0882 13.9883 11.7 12.0001 11.7C10.0118 11.7 8.40007 10.0882 8.40007 8.1C8.40007 6.11177 10.0118 4.5 12.0001 4.5C13.9883 4.5 15.6001 6.11177 15.6001 8.1Z" stroke="var(--tg-theme-text-color)" stroke-width="2" stroke-linecap="round" />
        </svg>
      </div>
      {userData ? (
          <div className="form-info">
    ...
    <div className='data-field' onClick={onClickUserData}>
        <div>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M12.0001 21.6C12.0001 21.6 19.5131 14.9218 19.5131 9.91307C19.5131 5.76373 16.1494 2.40002 12.0001 2.40002C7.85076 2.40002 4.48706 5.76373 4.48706 9.91307C4.48706 14.9218 12.0001 21.6 12.0001 21.6Z" stroke="var(--tg-theme-text-color)" stroke-width="2"/>
          <path d="M14.4004 9.60018C14.4004 10.9257 13.3259 12.0002 12.0004 12.0002C10.6749 12.0002 9.60041 10.9257 9.60041 9.60018C9.60041 8.27469 10.6749 7.20018 12.0004 7.20018C13.3259 7.20018 14.4004 8.27469 14.4004 9.60018Z" stroke="var(--tg-theme-text-color)" stroke-width="2"/>
          </svg>
        </div>
      {userData ? (
        <div className='form-info'>
