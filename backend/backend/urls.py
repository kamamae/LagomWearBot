...
from main.views import ProductAPIView,DetailProductAPIView, AddToCart, CartAPIView, UserAPIView, User,SizeAPIView,ProfileRetrieveAPIView,EditQuantityAPIView,CreateProfileAPIView,PriceCartAPIView
...
urlpatterns = [
    ...
    path('api/v1/cart/<int:telegram_id>/price/', PriceCartAPIView().as_view()),
